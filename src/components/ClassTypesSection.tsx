            ...
            >
              <div className="relative rounded-2xl border border-dark-border hover:border-gold/20 bg-dark-card overflow-hidden card-lift transition-all duration-500">
                ...
                <div className="relative p-6 sm:p-8">
                  ...
                  <motion.a
                    href="#demo"
                    className="block text-center py-3 rounded-xl border border-dark-border hover:border-gold/30 text-sm font-semibold text-text-secondary hover:text-gold transition-all duration-300 hover:bg-gold/5"
